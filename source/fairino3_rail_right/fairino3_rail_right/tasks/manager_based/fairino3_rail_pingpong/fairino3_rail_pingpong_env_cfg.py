...
from fairino3_rail_right.assets.fairino3_v6_rail import FAIRINO3_V6_RAIL_PADDLE_CFG
...
class EventCfg:
    ...
    reset_ball = EventTerm(
        ...
        params={
            ...
            "net_x": NET_X,
            "pos_mean": (0.57, 0.02, 1.05),
            "pos_std": (0.01, 0.19, 0.11),
            "vel_mean": (2.35, 0.05, -1.24),
            "vel_std": (0.50, 0.31, 0.72),
            "home_side": "right",
        },
    )
