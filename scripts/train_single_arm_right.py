...
parser.add_argument(
    "--ball-speed-scale", type=float, default=1.0,
    help="Curriculum: scale serve ball speed uniformly (0.3 = 30% speed). Survives serve-legality check.",
)
parser.add_argument(
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    # Curriculum: expose ball_speed_scale on the env so reset_ball_valid_serve can read it
    if args_cli.ball_speed_scale != 1.0:
        env.unwrapped._ball_speed_scale = args_cli.ball_speed_scale
